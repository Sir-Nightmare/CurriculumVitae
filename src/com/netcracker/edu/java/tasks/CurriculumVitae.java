...
//ЦЕЛИ ЗАДАЧИ
//        - Изучить регулярные выражения (включая группы), java.util.regex и java.lang.String.
//        - Попрактиковаться в ОО-программировании и использовании Java Collections Framework.
//        - Привыкать выбрасывать исключения во всех случаях, когда это требуется,
//        но с минимальным количеством операторов throw.
//
//        ЗАДАНИЕ
//        Реализовать класс, хранящий текст одного резюме (curriculum vitae, CV) с возможностью изменять некоторые его части.
//        Геттер-методы класса возвращают имена и телефоны, взятые из CV;
//        методы update* изменяют фамилию и телефоны прямо в тексте CV.
//        Класс также может скрывать и обратно раскрывать персональные данные из CV.
//
...
//        Your class must be named CurriculumVitaeImpl.
